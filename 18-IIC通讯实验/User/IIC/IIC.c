...
void I2C_EE_Config(void)
{
  ...
  EEPROM_I2C_GPIO_APBxClkCmd(EEPROM_I2C_SCL_GPIO_CLK|EEPROM_I2C_SDA_GPIO_CLK,ENABLE);        //打开IIC的GPIO的时钟

  EEPROM_I2C_APBxClkCmd(EEPROM_I2C_CLK, ENABLE);      				  //打开IIC外设的时钟
  ...
  //配置I2C的工作参数
	...
	I2C_InitStructure.I2C_AcknowledgedAddress = I2C_AcknowledgedAddress_7bit;//使用七位地址模式
...
//向EEPROM写入多个字节（页写入）每次写入不能超过八个字节
