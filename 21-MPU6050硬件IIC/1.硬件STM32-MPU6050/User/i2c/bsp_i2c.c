...
static void I2C_Mode_Configu(void)
{
  ...
  I2C_InitStructure.I2C_Ack = I2C_Ack_Enable ;
	...
	/* I2C的寻址模式 */
  I2C_InitStructure.I2C_AcknowledgedAddress = I2C_AcknowledgedAddress_7bit;//这里要与HPU6050配套
...
{  
  ...
  /* Send slave address for write */
  I2C_Send7bitAddress(SENSORS_I2Cx, MPU6050_SLAVE_ADDRESS, I2C_Direction_Transmitter);//发送陀螺仪的设备地址作为写方向
  ...
  I2C_Send7bitAddress(SENSORS_I2Cx, MPU6050_SLAVE_ADDRESS, I2C_Direction_Receiver);//再次发送设备地址，作为接收器读取数据
